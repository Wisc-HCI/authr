(define (problem elevators-time-cost-p05-p07)
...
(= (travel-slow-temp n16 n17) 12) (= (travel-slow-temp n16 n18) 20) (= (travel-slow-temp n16 n19) 28) (= (travel-slow-temp n16 n20) 36) (= (travel-slow-temp n16 n21) 44) (= (travel-slow-temp n16 n22) 52) (= (travel-slow-temp n16 n23) 60) (= (travel-slow-temp n16 n24) 68) (= (travel-slow-temp n17 n18) 12) (= (travel-slow-temp n17 n19) 20) (= (travel-slow-temp n17 n20) 28) (= (travel-slow-temp n17 n21) 36) (= (travel-slow-temp n17 n22) 44) (= (travel-slow-temp n17 n23) 52) (= (travel-slow-temp n17 n24) 60) (= (travel-slow-temp n18 n19) 12) (= (travel-slow-temp n18 n20) 20) (= (travel-slow-temp n18 n21) 28) (= (travel-slow-temp n18 n22) 36) (= (travel-slow-temp n18 n23) 44) (= (travel-slow-temp n18 n24) 52) (= (travel-slow-temp n19 n20) 12) (= (travel-slow-temp n19 n21) 20) (= (travel-slow-temp n19 n22) 28) (= (travel-slow-temp n19 n23) 36) (= (travel-slow-temp n19 n24) 44) (= (travel-slow-temp n20 n21) 12) (= (travel-slow-temp n20 n22) 20) (= (travel-slow-temp n20 n23) 28) (= (travel-slow-temp n20 n24) 36) (= (travel-slow-temp n21 n22) 12) (= (travel-slow-temp n21 n23) 20) (= (travel-slow-temp n21 n24) 28) (= (travel-slow-temp n22 n23) 12) (= (travel-slow-temp n22 n24) 20) (= (travel-slow-temp n23 n24) 12) 


(= (travel-fast-temp n0 n4) 13) (= (travel-fast-temp n0 n8) 17) (= (travel-fast-temp n0 n12) 20) (= (travel-fast-temp n0 n16) 22) (= (travel-fast-temp n0 n20) 24) (= (travel-fast-temp n0 n24) 26) 

(= (travel-fast-temp n4 n8) 13) (= (travel-fast-temp n4 n12) 17) (= (travel-fast-temp n4 n16) 20) (= (travel-fast-temp n4 n20) 22) (= (travel-fast-temp n4 n24) 24) 

(= (travel-fast-temp n8 n12) 13) (= (travel-fast-temp n8 n16) 17) (= (travel-fast-temp n8 n20) 20) (= (travel-fast-temp n8 n24) 22) 

(= (travel-fast-temp n12 n16) 13) (= (travel-fast-temp n12 n20) 17) (= (travel-fast-temp n12 n24) 20) 

(= (travel-fast-temp n16 n20) 13) (= (travel-fast-temp n16 n24) 17) 

(= (travel-fast-temp n20 n24) 13) 
...
(= (travel-slow-cost n16 n17) 6) (= (travel-slow-cost n16 n18) 7) (= (travel-slow-cost n16 n19) 8) (= (travel-slow-cost n16 n20) 9) (= (travel-slow-cost n16 n21) 10) (= (travel-slow-cost n16 n22) 11) (= (travel-slow-cost n16 n23) 12) (= (travel-slow-cost n16 n24) 13) (= (travel-slow-cost n17 n18) 6) (= (travel-slow-cost n17 n19) 7) (= (travel-slow-cost n17 n20) 8) (= (travel-slow-cost n17 n21) 9) (= (travel-slow-cost n17 n22) 10) (= (travel-slow-cost n17 n23) 11) (= (travel-slow-cost n17 n24) 12) (= (travel-slow-cost n18 n19) 6) (= (travel-slow-cost n18 n20) 7) (= (travel-slow-cost n18 n21) 8) (= (travel-slow-cost n18 n22) 9) (= (travel-slow-cost n18 n23) 10) (= (travel-slow-cost n18 n24) 11) (= (travel-slow-cost n19 n20) 6) (= (travel-slow-cost n19 n21) 7) (= (travel-slow-cost n19 n22) 8) (= (travel-slow-cost n19 n23) 9) (= (travel-slow-cost n19 n24) 10) (= (travel-slow-cost n20 n21) 6) (= (travel-slow-cost n20 n22) 7) (= (travel-slow-cost n20 n23) 8) (= (travel-slow-cost n20 n24) 9) (= (travel-slow-cost n21 n22) 6) (= (travel-slow-cost n21 n23) 7) (= (travel-slow-cost n21 n24) 8) (= (travel-slow-cost n22 n23) 6) (= (travel-slow-cost n22 n24) 7) (= (travel-slow-cost n23 n24) 6) 


(= (travel-fast-cost n0 n4) 13) (= (travel-fast-cost n0 n8) 25) (= (travel-fast-cost n0 n12) 37) (= (travel-fast-cost n0 n16) 49) (= (travel-fast-cost n0 n20) 61) (= (travel-fast-cost n0 n24) 73) 

(= (travel-fast-cost n4 n8) 13) (= (travel-fast-cost n4 n12) 25) (= (travel-fast-cost n4 n16) 37) (= (travel-fast-cost n4 n20) 49) (= (travel-fast-cost n4 n24) 61) 

(= (travel-fast-cost n8 n12) 13) (= (travel-fast-cost n8 n16) 25) (= (travel-fast-cost n8 n20) 37) (= (travel-fast-cost n8 n24) 49) 

(= (travel-fast-cost n12 n16) 13) (= (travel-fast-cost n12 n20) 25) (= (travel-fast-cost n12 n24) 37) 

(= (travel-fast-cost n16 n20) 13) (= (travel-fast-cost n16 n24) 25) 

(= (travel-fast-cost n20 n24) 13) 
