...
% Définition, syntax, state-of-the-art, few words on the impact on implementation in optimal CPT quite natural with constraint programming ...
...
%\newblock Direction R\'egionale de l'\'Equipement (DRE), Observation des déplacements sur Voies Rapides.
...
%Ref traffic
%%%%%%%%%%%%%%%%
%Philippe Légé, « Sécurité et sûreté des transports - État de l’art », Synthèse INRETS No 58, Contrat DRI/INRETS no 07 MTE048, Contrat DGITM/INRETS no 07 MTE048, Groupe opérationnel no 2 du PREDIT, 2008
